...
#try        # ウィンドウ全体に太い枠を描画します。
#try        THICKNESS = 20
#try        height, width = rgb_image.shape[:2]
#try        cv2.rectangle(rgb_image, (0 + THICKNESS, 0 + THICKNESS), (width - THICKNESS, height - THICKNESS), color, thickness=20)
